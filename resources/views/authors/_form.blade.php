...
700"> 
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6"> 
        <div> 
            <label for="nationality" class="block text-sm font-medium text-slate
700">Nacionalidad</label> 
...
700">Fecha de nacimiento</label> 
            <input type="date" name="birth_date" id="birth_date" max="{{ date('Y-m
d') }}" 
                   value="{{ old('birth_date', $isEdit ? optional($author
>birth_date)->format('Y-m-d') : '') }}" 
    ...
    <div>
        <label for="biography" class="block text-sm font-medium text-slate
700">Biografía</label> 
