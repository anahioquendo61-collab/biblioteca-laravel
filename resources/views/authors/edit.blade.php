...
<div class="max-w-3xl mx-auto px-4 py-8"> 
    ...
    <div class="mb-6 flex items-center justify-between"> 
        ...
        <a href="{{ route('authors.show', $author) }}" 
           class="text-sm text-slate-600 hover:text-slate-900">← Volver al autor</a> 
    </div> 
    ...
    <form method="POST" action="{{ route('authors.update', $author) }}" 
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6"> 
            <div> 
                <label for="first_name" class="block text-sm font-medium text-slate
700"> 
...
sm 
            ...
            <div> 
                <label for="last_name" class="block text-sm font-medium text-slate
700"> 
...
sm 
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6"> 
            <div> 
                <label for="nationality" class="block text-sm font-medium text
slate-700"> 
                    Nacionalidad 
                </label> 
...
sm 
            ...
            <div> 
                <label for="birth_date" class="block text-sm font-medium text-slate
700"> 
                    Fecha de nacimiento 
                </label> 
                <input type="date" name="birth_date" id="birth_date" 
                       max="{{ date('Y-m-d') }}" 
                       value="{{ old('birth_date', optional($author->birth_date)
>format('Y-m-d')) }}" 
                       class="mt-1 block w-full rounded-md border-slate-300 shadow
sm 
 focus:border-indigo-500 focus:ring-indigo-500"> 
...
old('biography', $author->biography) }}</textarea> 
        ...
        <div class="flex items-center justify-end gap-3 pt-4 border-t border-slate
200"> 
            <a href="{{ route('authors.show', $author) }}" 
